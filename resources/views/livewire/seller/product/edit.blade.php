<div class="w-full space-y-4 sm:space-y-6">
    ...
    <div class="flex items-start justify-between gap-3">
        <div>
            <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800">Edit Produk</h1>
            <p class="text-xs sm:text-sm text-gray-600 mt-1">Perbarui informasi produk</p>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow overflow-hidden">
        <div class="p-4 sm:p-5 border-b border-gray-100 flex items-center justify-between">
            <h3 class="text-base lg:text-lg font-semibold text-gray-800">Form Edit Produk</h3>
        ...
        " @blur="$wire.set('stock', raw)"
            ...
            <div>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <p class="text-xs text-gray-500 mb-2">Ganti (opsional):</p>
